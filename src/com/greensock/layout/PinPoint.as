 ...
 */	 
	public class PinPoint extends Point implements IEventDispatcher {
		/** @private **/
		public static const version:Number = 2.021;
		/** @private **/
		 ...
		 */
		public function PinPoint(x:Number, y:Number, target:DisplayObject) {
			super(x, y);
		...
		protected function init(target:DisplayObject):void {
			_data = new LiquidData(this, target, 0, false, 0, null);
		...
		override public function clone():Point {
			return new PinPoint(this.x, this.y, _data.target);
		}
